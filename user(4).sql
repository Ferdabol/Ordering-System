...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2025 at 12:31 PM
...
INSERT INTO `food` (`food_id`, `Name`, `Description`, `Image`, `Time`, `category`) VALUES
(1, 'Pancit', 'Masarap ang pancit!', 'uploads/Screenshot (62).png', '20', 'Uncategorized'),
(2, 'Manok', 'Masarap ang Manok!', 'uploads/Screenshot (61).png', '10', 'Uncategorized'),
(3, 'Ewan', 'Ewan ko!', 'uploads/Screenshot (54).png', '1', 'Uncategorized');
...
--
ALTER TABLE `food_size_pricing`
  MODIFY `pricing_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
